                ...
                <div class = "about-me-grid" style = "margin: 2%">
                    ...
                    <div class = "about-me-grid-item-two-columns" style = "text-align:left">
                        ...
                        <div class = "credentials-list">
                            ...
                            <ul style="font-size:150%; line-height:200%; margin-top: 1%; padding: 30px">
                                ...
                                <li><p>Croatian Junior team chess champion (2019)</p></li>
                                <li><p>Former <b>top 10</b> U20 player in Croatia</p></li></em>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class = "slider-area">
                            <div class = "container">
                                <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                                    ...
                                    <span class="carousel-control-next-icon btn-span" aria-hidden="true"></span>
                                    <span class="sr-only btn-span">Next</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class = "about-me-grid-item-two-columns" style = "height: 150px">
                        <a class="opt-in-button" href="http://reservationsystem.test/contact">
                            <span class="btn-span">I'm ready to improve!</span>
                        </a>
                    </div>
                </div>
            </div>
