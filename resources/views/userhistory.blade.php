            ...
            <div class="jumbotron"
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="UserList">
                        <thead>
                            <tr>
                                <th style="cursor: pointer;" scope="col" onClick="sortTable(0, 0)">Name of user and
                                    package <span style="color: rgb(0, 168, 243);">▲▼</span></th>
                                <th style="cursor: pointer;" scope="col" onClick="sortTable(1, 0)">Start <span style="color: rgb(0, 168, 243);">▲▼</span></th>
                                <th style="cursor: pointer;" scope="col" onClick="sortTable(2, 0)">End <span style="color: rgb(0, 168, 243);">▲▼</span></th>
