        ...
        <div class="grid grid-cols-1 md:grid-cols-2" style="display:flex; background-color:rgba(179, 179, 179, 0.7);">
            ...
            <div class="jumbotron"
                ...
                <div class="container text">
                    ...
                    <div class="row margin20">
                        <div class="col-sm slide-in from-left">
                            In Europe, chess was perfected by the introduction of castling and the increasing activity
                            of the
                            queen and bishop.
                    ...
                    <div class="row margin20">
                        ...
                        <div class="col-sm right slide-in from-right">
                            Competitive chess started in 1834 with La Bourdonnai-McDonnel matches and 1851 London Chess
                            tournament.
                            At that time, five-minute chess also started developing.
                            The most popular version started being the one where each player had a bank of time in which
                            to play
                            a previously agreed number of moves,
                            for example 2 hours for 30 moves. The player who made the predetermined number of moves in
                            the
