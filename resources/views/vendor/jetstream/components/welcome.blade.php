                ...
                <div class="col-md-6 pr-0">
                    <div class="card-body border-right border-bottom p-3 h-100">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="pl-3">
                                <div class="mb-2">
                                    <p class="h5 font-weight-bolder text-decoration-none text-dark">Reservations</p>
                                </div>
                                <p class="text-muted">
                                    Lorem ipsum
                                </p>
                ...
                <div class="col-md-6 pr-0">
                    <div class="card-body border-right p-3 h-100">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="pl-3">
                                <div class="mb-2">
                                    <p class="h5 font-weight-bolder text-decoration-none text-dark">See testimonials</p>
                                </div>
                                <p class="text-muted">
                                    Lorem ipsum
                                </p>
